...
--     DECLARE @StudentCGPA FLOAT;


--     SELECT @StudentCGPA = avg(GPA)
--     FROM Registration
...
--     IF @StudentCGPA < 2.5
--     BEGIN
--         -- Display a message indicating why enrollment is not allowed
--         PRINT 'You can not enroll courses with a CGPA less then 2.5';
...
--         PRINT 'Error occurred during enrollment: ' + @error_message;
--     END CATCH
-- END

-- drop procedure EnrollStudent

-- EXEC EnrollStudent 'Spring2017', '1', 10, 'A', 4;